...
<html lang="en">
  <head>
    ...
    <title>HUA - Tankok felvitele</title>
  </head>
    ...
    <div class="container-fluid rounded col-md-9 col-sm-12 bg-dark pb-3">
        ...
        <form>
            ...
            <div class="col-12 col-md-2 my-1">
                ...
                <p id="talalat" hidden>Nincs ilyen tank!</p>
                <select name="tank" id="tankok" class="form-control">
                </select>
                </div>
                <div class="col-12 col-md-2 my-1">
                ...
                <div class="col col-md-2 my-1">
                    <button type="button" class="btn btn-danger btn-block" id="tovabb" title="Ha nincs egy tankod se, kattints erre">Tovább</button>
                </div>
            </div>
        </form>
    </div>
...
<form method="POST">
    ...
    <script src="js\jelentkezotank.js"></script>
